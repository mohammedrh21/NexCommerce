...
namespace Infrastructure.Migrations
{
    ...
    public partial class AddOrderShippingAddress : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CouponTranslations_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "VendorProfileTranslations",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VendorProfileTranslations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VendorProfileTranslations_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VendorProfileTranslations_VendorProfiles_VendorProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CouponTranslations_CouponId_LanguageId",
                table: "CouponTranslations",
                columns: new[] { "CouponId", "LanguageId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CouponTranslations_LanguageId",
                table: "CouponTranslations",
                column: "LanguageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductTranslations_Name",
                table: "ProductTranslations",
                column: "Name");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VendorProfileTranslations_LanguageId",
                table: "VendorProfileTranslations",
                column: "LanguageId");

            migrationBuilder.CreateIndex(
                name: "IX_VendorProfileTranslations_VendorProfileId_LanguageId",
                table: "VendorProfileTranslations",
                columns: new[] { "VendorProfileId", "LanguageId" },
                unique: true);
